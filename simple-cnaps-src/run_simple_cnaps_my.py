...
class Learner:
    ...
    def parse_command_line(self):
        ...
        parser.add_argument("--checkpoint_dir", "-c", default='../../simple-cnaps-checkpoints', help="Directory to save checkpoint to.")
        ...
        parser.add_argument("--max_way_train", type=int, default=5,     # 40
                            help="Maximum way of meta-dataset meta-train task.")
        parser.add_argument("--max_way_test", type=int, default=5, help="Maximum way of meta-dataset meta-test task.")  # 50
        parser.add_argument("--max_support_train", type=int, default=5,   # 400
                            help="Maximum support set size of meta-dataset meta-train task.")
        parser.add_argument("--max_support_test", type=int, default=5,      # 500
                            help="Maximum support set size of meta-dataset meta-test task.")
        parser.add_argument("--shuffle_dataset", type=bool, default=False,   # True
